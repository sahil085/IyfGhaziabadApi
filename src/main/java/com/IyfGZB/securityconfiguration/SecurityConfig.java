...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and()
                ...
                .antMatchers("/account/register","/ttn/compile","/account/login","/logout","/account/check","/admin/drive","/sheet/*","/callingSewa/allocate","/masterSheet/*","/populateAttendance","/sheet/userList").permitAll()
