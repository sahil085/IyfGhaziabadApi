...
<nav class="navbar navbar-default ">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html"><img src="/resources/assets/img/logo.png" class="img-responsive" width="80px" alt=""></a>
        </div>
        ...
        <div class="collapse navbar-collapse yamm" id="navigation">
            <div class="button navbar-right">
               ...
               <a href="/register"> <button class="navbar-btn nav-button wow fadeInRight"  data-wow-delay="0.48s">Register / Signup</button></a>
            </div>
